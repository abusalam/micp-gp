...
<a href="<?=env('app.linkToYouTubeChannel')?>" target="_blank" role="button">
	<svg viewBox="0 0 320 60" preserveAspectRatio="xMidYMid meet" focusable="false"
			style="pointer-events: none; display: block; width: 100%; height: 100%;">
			<g viewBox="0 0 320 60" preserveAspectRatio="xMidYMid meet">
				<g>
				...
				<g>
					<text x="70" y="46" class="hidden-lm" font-size="xxx-large" fill="#fff">ePathshala</text>
					<text x="70" y="46" class="hidden-dm" font-size="xxx-large" fill="#000">ePathshala</text>
				</g>
				<!-- <g>
					<g id="youtube-paths">
