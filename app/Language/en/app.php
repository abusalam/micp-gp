<?php
	return [
		...
		'booking'     => [
			...
			'dailyReportTitle'=> 'Gate Passes Issued on/during ({date})',
			'blacklistReport' => 'Blacklist Report',
		],
		'blacklist' => [
			'blacklist'       => 'Truck No / DL No',
			'blacklistTitle'  => 'Blacklist Truck / Driver',
			...
			'addSuccess'      => 'Truck No / DL No: <b>{blacklist_no}</b> has been blacklisted successfully.',
			'removeSuccess'   => 'Truck No / DL No: <b>{blacklist_no}</b> has been removed from blacklist successfully.',
		],
	];
